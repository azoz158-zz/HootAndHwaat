...
import UserTripOrderUnit from '../comps/UserTripOrderUnit'
...
@inject("store")
@observer
export default class UserTripsOrders extends Component {
  constructor(props) {
    super(props);
    this.state = {
        page: 0,
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <FlatList
                        ...
                        renderItem={({ item, index }) => (<UserTripOrderUnit data={item} ind={index}
