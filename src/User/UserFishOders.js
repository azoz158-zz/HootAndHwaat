...
import UserFishOrderUnit from '../comps/UserFishOrderUnit'
...
@inject("store")
@observer
export default class UserFishOrders extends Component {
  constructor(props) {
    super(props);
    this.state = {
        page: 0,
...
componentDidMount(){
    axios.get('http://hootandhawat-001-site1.ftempurl.com/api/get/orders/all/fishes/user_id='+ this.props.store.userId+'&page=1', {
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <FlatList
                        ...
                        renderItem={({ item, index }) => (<UserFishOrderUnit data={item} ind={index}
