...
@inject("store")
@observer
export default class CustomerFishCard extends Component {
    constructor(props) {
        super(props);
        this.state = {
            buying: false,
...
//CoconNextArabic-Light
    delete = () => {
        ...
        axios.delete('http://hootandhawat-001-site1.ftempurl.com/api/remove/fish/fish_id=' + this.props.data.f_id + '&customer_id=' + this.props.store.userId,{})
            .then(Response => {
                //(Response)
            ...
            return (
                <View style={{ flex: 1, flexDirection: 'row', backgroundColor: 'white', padding: 10 }}>
                    ...
                    <Right>
                        ...
                        <Text style={{ color: 'black', fontFamily: Platform.OS === 'ios' ? 'CoconNextArabic-Light' : 'Cocon® Next Arabic-Light' }}>{this.props.store.strings.f_quantity} {this.props.data.f_quantity} {this.props.store.strings.kg}</Text>
                        ...
                        <View style={{ flexDirection: 'row', width: '100%', backgroundColor: 'rgba(000,000,000,.5)', padding: 10 }}>
                            ...
                            <Right>
                                ...
                                <View style={{ flexDirection: 'row', alignContent: 'center', alignItems: 'center' }}>
                                    <Text style={{ color: 'white', fontFamily: Platform.OS === 'ios' ? 'CoconNextArabic-Light' : 'Cocon® Next Arabic-Light', marginRight: 10 }}>{this.props.store.strings.fishingDate} {this.props.data.created_at}</Text>
